DefinitionBlock ("SSDT-GA-Z77X-UP7.aml", "SSDT", 1, "APPLE", "tinySSDT", 0x00000001)
{
	...
	External (_SB.PCI0.LPCB.UAR1._STA, IntObj)
	...
	/* Calls to _OSI in the DSDT are routed to here */
	...
	Method (\_SB._INI)
	{
		...
		/* Disabling the UAR1 device */
		Store (Zero, \_SB.PCI0.LPCB.UAR1._STA)
